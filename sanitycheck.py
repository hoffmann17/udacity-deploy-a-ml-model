...
def run_sanity_check(test_dir):
    """
    Perform a sanity check to ensure the code meets rubric criteria.
    """
    ...
    if not test_functions_for_get:
        ...
        print(f"{FAIL_COLOR}Please make sure you have a test case for the GET method."
    ...
    if not test_functions_for_post:
        ...
        print(f"{FAIL_COLOR}Please make sure you have TWO test cases for the POST() method."
